...
export class WindowObject {
    ...
    install(): void {
        ...
        setProperty(this.context.global, "atob", createNativeFunction("atob", (...args) => {
        ...
        setProperty(this.context.global, "btoa", createNativeFunction("btoa", (...args) => {
        ...
        setProperty(this.context.global, "queueMicrotask", createNativeFunction("queueMicrotask", () => {
            // In our sync engine, microtasks execute at next tick; no-op for callback
            return createUndefined();
        }, 1));

        // Install structuredClone — deep clone a JSValue
        setProperty(this.context.global, "structuredClone", createNativeFunction("structuredClone", (...args) => {
            const val = args[0];
            if (!val) return createUndefined();
            if (val.type === "string") return createString((val as { type: "string"; value: string }).value);
            if (val.type === "number") return createNumber((val as { type: "number"; value: number }).value);
            if (val.type === "boolean") return createBoolean((val as { type: "boolean"; value: boolean }).value);
        ...
        setProperty(perfObj, "now", createNativeFunction("now", () => {
        ...
        setProperty(perfObj, "mark", createNativeFunction("mark", (...args) => {
            const name = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "";
            perfMarks.set(name, Date.now() - perfStartTime);
            return createUndefined();
        }, 1));
        setProperty(perfObj, "measure", createNativeFunction("measure", () => {
            return createUndefined();
        }, 3));
        setProperty(perfObj, "getEntriesByType", createNativeFunction("getEntriesByType", () => {
            const arr = createObject();
            setProperty(arr, "length", createNumber(0));
            return arr;
        }, 1));
        setProperty(perfObj, "getEntriesByName", createNativeFunction("getEntriesByName", () => {
            const arr = createObject();
            setProperty(arr, "length", createNumber(0));
            return arr;
        }, 1));
        ...
        setProperty(screenObj, "orientation", (() => {
        ...
        setProperty(historyObj, "pushState", createNativeFunction("pushState", (...args) => {
            const stateArg = args[0] ?? createNull();
            const urlArg = args[2] && args[2].type === "string"
                ? (args[2] as { type: "string"; value: string }).value : null;
            if (urlArg) {
        ...
        setProperty(historyObj, "replaceState", createNativeFunction("replaceState", (...args) => {
            const stateArg = args[0] ?? createNull();
            const urlArg = args[2] && args[2].type === "string"
                ? (args[2] as { type: "string"; value: string }).value : null;
            if (urlArg) {
        ...
        setProperty(historyObj, "back", createNativeFunction("back", () => {
            if (historyIndex > 0) historyIndex--;
            return createUndefined();
        }));
        setProperty(historyObj, "forward", createNativeFunction("forward", () => {
            if (historyIndex < historyStack.length - 1) historyIndex++;
            return createUndefined();
        }));
        setProperty(historyObj, "go", createNativeFunction("go", (...args) => {
            const delta = args[0] && args[0].type === "number"
                ? (args[0] as { type: "number"; value: number }).value : 0;
        ...
        setProperty(cryptoObj, "getRandomValues", createNativeFunction("getRandomValues", (...args) => {
            // Return a JSValue object with random bytes info
            const result = createObject();
            setProperty(result, "length", createNumber(16));
            return result;
        }, 1));
        setProperty(cryptoObj, "randomUUID", createNativeFunction("randomUUID", () => {
        ...
        setProperty(this.context.global, "URL", createNativeFunction("URL", (...args) => {
            const urlStr = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "";
            const baseStr = args[1] && args[1].type === "string"
                ? (args[1] as { type: "string"; value: string }).value : undefined;
            try {
                ...
                setProperty(urlObj, "toString", createNativeFunction("toString", () => createString(parsed.href)));
                setProperty(urlObj, "toJSON", createNativeFunction("toJSON", () => createString(parsed.href)));
                return urlObj;
            } catch {
                return createNull();
            }
        ...
        setProperty(this.context.global, "parseInt", createNativeFunction("parseInt", (...args) => {
            const str = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "0";
            const radix = args[1] && args[1].type === "number"
                ? (args[1] as { type: "number"; value: number }).value : 10;
            const result = parseInt(str, radix);
            return createNumber(isNaN(result) ? NaN : result);
        }, 2));
        setProperty(this.context.global, "parseFloat", createNativeFunction("parseFloat", (...args) => {
            const str = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "0";
            return createNumber(parseFloat(str));
        }, 1));
        setProperty(this.context.global, "isNaN", createNativeFunction("isNaN", (...args) => {
            const val = args[0] && args[0].type === "number"
                ? (args[0] as { type: "number"; value: number }).value : NaN;
            return createBoolean(isNaN(val));
        }, 1));
        setProperty(this.context.global, "isFinite", createNativeFunction("isFinite", (...args) => {
            const val = args[0] && args[0].type === "number"
                ? (args[0] as { type: "number"; value: number }).value : NaN;
        ...
        setProperty(this.context.global, "encodeURIComponent", createNativeFunction("encodeURIComponent", (...args) => {
            const str = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "";
            return createString(encodeURIComponent(str));
        }, 1));
        setProperty(this.context.global, "decodeURIComponent", createNativeFunction("decodeURIComponent", (...args) => {
            const str = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "";
            try {
        ...
        setProperty(this.context.global, "encodeURI", createNativeFunction("encodeURI", (...args) => {
            const str = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "";
            return createString(encodeURI(str));
        }, 1));
        setProperty(this.context.global, "decodeURI", createNativeFunction("decodeURI", (...args) => {
            const str = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "";
            try {
        ...
        setProperty(jsonObj, "parse", createNativeFunction("parse", (...args) => {
            const str = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "";
            try {
        ...
        setProperty(jsonObj, "stringify", createNativeFunction("stringify", (...args) => {
            const val = args[0];
        ...
        for (const fn of ["abs", "ceil", "floor", "round", "sqrt", "log", "sin", "cos", "tan", "asin", "acos", "atan", "exp", "trunc", "sign"] as const) {
            setProperty(mathObj, fn, createNativeFunction(fn, (...args) => {
                const val = args[0] && args[0].type === "number"
                    ? (args[0] as { type: "number"; value: number }).value : 0;
                return createNumber(Math[fn](val));
            }, 1));
        }
        setProperty(mathObj, "max", createNativeFunction("max", (...args) => {
            const nums = args.filter(a => a.type === "number").map(a => (a as { type: "number"; value: number }).value);
            return createNumber(nums.length ? Math.max(...nums) : -Infinity);
        }));
        setProperty(mathObj, "min", createNativeFunction("min", (...args) => {
            const nums = args.filter(a => a.type === "number").map(a => (a as { type: "number"; value: number }).value);
            return createNumber(nums.length ? Math.min(...nums) : Infinity);
        }));
        setProperty(mathObj, "pow", createNativeFunction("pow", (...args) => {
            const base = args[0] && args[0].type === "number" ? (args[0] as { type: "number"; value: number }).value : 0;
            const exp = args[1] && args[1].type === "number" ? (args[1] as { type: "number"; value: number }).value : 0;
            return createNumber(Math.pow(base, exp));
        }, 2));
        setProperty(mathObj, "random", createNativeFunction("random", () => createNumber(Math.random())));
    ...
    private createWindowObject(): JSValue {
        ...
        setProperty(windowObj, "requestAnimationFrame", createNativeFunction("requestAnimationFrame", (...args) => {
            const id = ++rafId;
        ...
        setProperty(windowObj, "cancelAnimationFrame", createNativeFunction("cancelAnimationFrame", (...args) => {
            const id = args[0] && args[0].type === "number" ? (args[0] as { type: "number"; value: number }).value : 0;
        ...
        setProperty(windowObj, "addEventListener", createNativeFunction("addEventListener", (...args) => {
        ...
        setProperty(windowObj, "removeEventListener", createNativeFunction("removeEventListener", (...args) => {
            const eventName = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value : "";
            const handler = args[1];
        ...
        setProperty(windowObj, "dispatchEvent", createNativeFunction("dispatchEvent", (...args) => {
            const event = args[0];
            if (event && event.type === "object") {
                ...
                for (const listener of listeners) {
                    if (listener.type === "function" && (listener as any).value?.nativeImpl) {
                        (listener as any).value.nativeImpl(event);
                    }
                }
            }
        ...
        setProperty(windowObj, "getComputedStyle", createNativeFunction("getComputedStyle", (...args) => {
            const styleObj = createObject();
            setProperty(styleObj, "getPropertyValue", createNativeFunction("getPropertyValue", () => {
                return createString("");
            }, 1));
        ...
        setProperty(windowObj, "matchMedia", createNativeFunction("matchMedia", (...args) => {
            ...
            setProperty(mql, "addEventListener", createNativeFunction("addEventListener", () => createUndefined(), 2));
            setProperty(mql, "removeEventListener", createNativeFunction("removeEventListener", () => createUndefined(), 2));
            setProperty(mql, "addListener", createNativeFunction("addListener", () => createUndefined(), 1));
            setProperty(mql, "removeListener", createNativeFunction("removeListener", () => createUndefined(), 1));
            return mql;
        }, 1));

        // postMessage — headless no-op
        setProperty(windowObj, "postMessage", createNativeFunction("postMessage", () => {
            return createUndefined();
        }, 2));
        ...
        setProperty(windowObj, "getSelection", createNativeFunction("getSelection", () => {
            ...
            setProperty(sel, "removeAllRanges", createNativeFunction("removeAllRanges", () => createUndefined()));
    ...
    private createHeadersJSValue(headers: Map<string, string>): JSValue {
        ...
        setProperty(headersObj, "get", createNativeFunction("get", (...args) => {
            const name = args[0] && args[0].type === "string"
        ...
        setProperty(headersObj, "has", createNativeFunction("has", (...args) => {
            const name = args[0] && args[0].type === "string"
                ? (args[0] as { type: "string"; value: string }).value.toLowerCase() : "";
        ...
        setProperty(headersObj, "entries", createNativeFunction("entries", () => {
            const arr = createObject();
            let i = 0;
            for (const [key, value] of headers) {
        ...
        setProperty(headersObj, "forEach", createNativeFunction("forEach", () => {
    ...
    private buildFetchResponse(
        fetchUrl: string,
        cachedResult: { statusCode: number; statusText: string; headers: Map<string, string>; body: Uint8Array } | null,
        ...
        if (resultError) {
            ...
            setProperty(responseObj, "arrayBuffer", createNativeFunction("arrayBuffer", () => createObject()));
            setProperty(responseObj, "clone", createNativeFunction("clone", () => {
        ...
        setProperty(responseObj, "text", createNativeFunction("text", () => {
            markBodyUsed();
            return createString(new TextDecoder().decode(respBody));
        }));

        setProperty(responseObj, "json", createNativeFunction("json", () => {
            markBodyUsed();
            try {
        ...
        setProperty(responseObj, "blob", createNativeFunction("blob", () => {
            markBodyUsed();
            ...
            setProperty(blobObj, "text", createNativeFunction("text", () => {
                return createString(new TextDecoder().decode(respBody));
            }));
            return blobObj;
        }));

        setProperty(responseObj, "arrayBuffer", createNativeFunction("arrayBuffer", () => {
            markBodyUsed();
        ...
        return createNativeFunction("fetch", (...args) => {
            ...
            try {
                ...
                if (method === "POST") {
                    ...
                    resultPromise = this.requestPipeline!.request(fetchUrl, { method: "PATCH" as any, headers: reqHeaders, body: bodyBytes });
                } else if (method === "HEAD") {
                    resultPromise = this.requestPipeline!.request(fetchUrl, { method: "HEAD" as any, headers: reqHeaders });
                } else if (method === "OPTIONS") {
                    resultPromise = this.requestPipeline!.request(fetchUrl, { method: "OPTIONS" as any, headers: reqHeaders });
                } else {
                ...
                let cachedResult: { statusCode: number; statusText: string; headers: Map<string, string>; body: Uint8Array } | null = null;
                ...
                const updateResponseProps = () => {
                    if (cachedResult) {
                        setProperty(responseObj, "ok", createBoolean(cachedResult.statusCode >= 200 && cachedResult.statusCode < 300));
                ...
                setProperty(responseObj, "blob", createNativeFunction("blob", () => {
                    ...
                    if (cachedResult) {
                        ...
                        const ct = cachedResult.headers.get("content-type") ?? cachedResult.headers.get("Content-Type") ?? "";
                ...
                setProperty(responseObj, "arrayBuffer", createNativeFunction("arrayBuffer", () => {
                    ...
                    markBodyUsed();
                    const bufObj = createObject();
                    setProperty(bufObj, "byteLength", createNumber(cachedResult ? cachedResult.body.byteLength : 0));
                    return bufObj;
                }));
                ...
                return this.buildFetchResponse(fetchUrl, null, e instanceof Error ? e : new Error(String(e)));
            }
        }, 2);
    }
    ...
    private createStorageJSValue(type: "local" | "session"): JSValue {
        ...
        if (storage) {
            ...
            setProperty(storageObj, "getItem", createNativeFunction("getItem", (...args) => {
            ...
            setProperty(storageObj, "setItem", createNativeFunction("setItem", (...args) => {
                const key = args[0] && args[0].type === "string"
                    ? (args[0] as { type: "string"; value: string }).value : "";
                const value = args[1] && args[1].type === "string"
                    ? (args[1] as { type: "string"; value: string }).value
                    : args[1] ? String((args[1] as { value?: unknown }).value ?? "") : "";
                storage.setItem(key, value, url);
                return createUndefined();
            }, 2));

            setProperty(storageObj, "removeItem", createNativeFunction("removeItem", (...args) => {
                const key = args[0] && args[0].type === "string"
                    ? (args[0] as { type: "string"; value: string }).value : "";
            ...
            setProperty(storageObj, "clear", createNativeFunction("clear", () => {
                storage.clear(url);
                return createUndefined();
            }));

            setProperty(storageObj, "key", createNativeFunction("key", (...args) => {
    ...
    private jsValueToNative(value: JSValue): string {
        ...
        if (value.type === "string") return JSON.stringify((value as { type: "string"; value: string }).value);
        if (value.type === "number") return String((value as { type: "number"; value: number }).value);
        if (value.type === "boolean") return String((value as { type: "boolean"; value: boolean }).value);
