...
import { OffscreenWebGPU, OffscreenWebGPUError, OffscreenWebGPUState } from "./OffscreenWebGPU.ts";
...
const webgpuTest = hasWebGPU() ? Deno.test : (name: string, _fn: () => void | Promise<void>) => {
  Deno.test({
