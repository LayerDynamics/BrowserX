...
import { GPUDeviceState, GPUVendor } from "../../../types/webgpu.ts";
...
import { getOptimalWorkgroupSize, getVendorFeatures } from "../utils/DetectGPUType.ts";
...
export class WebGPUDevice {
  ...
  private extractLimits(): void {
    ...
    this.limits = {
      ...
      maxDynamicUniformBuffersPerPipelineLayout:
        nativeLimits.maxDynamicUniformBuffersPerPipelineLayout || 0,
      maxDynamicStorageBuffersPerPipelineLayout:
        nativeLimits.maxDynamicStorageBuffersPerPipelineLayout || 0,
  ...
  detectVendor(): GPUVendor {
    ...
    if (
      vendor.includes("apple") || description.includes("apple") || description.includes("m1") ||
      description.includes("m2")
    ) {
      return GPUVendor.APPLE;
    }
    if (
      vendor.includes("qualcomm") || description.includes("qualcomm") ||
      description.includes("adreno")
    ) {
