...
import { type DeviceConfig, WebGPUDevice } from "../adapter/Device.ts";
...
import { GPUDeviceError, GPUDeviceLostError, isRecoverableError } from "../errors.ts";
...
export class WebGPUDriver {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      this.log(
        `Driver initialized successfully in ${this.performanceMetrics.initializationTime}ms`,
      );
    } catch (error) {
