...
export class PDFGeneratorAPI {
    ...
    private toCoreOptions(options: PDFOptions): CorePDFOptions {
        ...
        let format: "A4" | "Letter" | "Legal" | "A3" = options.format as "A4" | "Letter" | "Legal" | "A3";
     ...
     */
    private parseMargins(margins?: PDFMargins): { top: number; right: number; bottom: number; left: number } {
