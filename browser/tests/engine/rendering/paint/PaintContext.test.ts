...
Deno.test({
  ...
  fn() {
    ...
    context.fillText("Hello", 10 as any, 20 as any, "16px Arial", "black");
...
Deno.test({
  ...
  fn() {
    ...
    context.fillText("Hello World", 10 as any, 20 as any, "16px Arial", "black");

    const params = context.commands[0].params as any;
    assertEquals(params.text, "Hello World");
    assertEquals(params.x, 10);
    assertEquals(params.y, 20);
    assertEquals(params.font, "16px Arial");
    assertEquals(params.color, "black");
  },
});
...
Deno.test({
  ...
  fn() {
    ...
    context.fillText("Text 1", 0 as any, 0 as any, "12px Arial", "black");
    context.fillText("Text 2", 0 as any, 0 as any, "20px Times New Roman", "red");

    assertEquals(context.commands.length, 2);
    assertEquals((context.commands[0].params as any).font, "12px Arial");
    assertEquals((context.commands[0].params as any).color, "black");
    assertEquals((context.commands[1].params as any).font, "20px Times New Roman");
    assertEquals((context.commands[1].params as any).color, "red");
  },
});
...
Deno.test({
  ...
  fn() {
    ...
    context.fillText("", 10 as any, 20 as any, "16px Arial", "black");
...
Deno.test({
  ...
  fn() {
    ...
    context.fillText("Title", 10 as any, 20 as any, "16px Arial", "black");
...
Deno.test({
  ...
  fn() {
    ...
    context.fillText("Test", 20 as any, 20 as any, "12px Arial", "black");
