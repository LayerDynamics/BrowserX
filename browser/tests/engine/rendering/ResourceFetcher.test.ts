...
Deno.test({ name: "ResourceFetcher - handleSpecialURL about:blank", ...testOpts, fn() {
...
Deno.test({ name: "ResourceFetcher - handleSpecialURL about:anything", ...testOpts, fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - handleSpecialURL data: text", ...testOpts, fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - handleSpecialURL data: base64", ...testOpts, fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - handleSpecialURL invalid data: URL returns undefined", ...testOpts, fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - handleSpecialURL normal URL returns undefined", ...testOpts, fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - clearResources", ...testOpts, fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - parseHTML basic document", ...testOpts, async fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - getDocumentElement from document node", ...testOpts, async fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - findStyleElements", ...testOpts, async fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
    const html = new TextEncoder().encode("<html><head><style>body{color:red}</style></head><body></body></html>");
    const dom = await fetcher.parseHTML(html as any);
    const styles = fetcher.findStyleElements(dom);
    assertEquals(styles.length >= 1, true);
}});

Deno.test({ name: "ResourceFetcher - getTextContent", ...testOpts, async fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - parseCSS", ...testOpts, async fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
...
Deno.test({ name: "ResourceFetcher - CSP set/get", ...testOpts, fn() {
    const rp = new RequestPipeline();
    const fetcher = new ResourceFetcher(rp);
