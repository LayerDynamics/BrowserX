...
import { GPUBufferState, GPUBufferUsageFlags } from "../../../../src/types/webgpu.ts";
...
if (webgpuAvailable) {
  let device: Awaited<ReturnType<typeof getSharedDevice>>;
  ...
  // Teardown after tests — device is shared, do not destroy it.
  function teardown() {
    // no-op
  }
