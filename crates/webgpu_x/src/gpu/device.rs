...
lazy_static::lazy_static! {
    ...
    static ref DEVICES: RwLock<HashMap<u64, (wgpu::Device, wgpu::Queue)>> = RwLock::new(HashMap::new());
    ...
    static ref TEXTURES: RwLock<HashMap<u64, wgpu::Texture>> = RwLock::new(HashMap::new());
}
