...
import { ActivityTracker, resetActivityTracker, initActivityTracker } from "../activity/ActivityTracker.ts";
...
Deno.test({
  ...
  async fn() {
    ...
    try {
      const tracker: ActivityTracker = initActivityTracker(TEST_BASE_DIR);
...
Deno.test({
  ...
  async fn() {
    ...
    try {
      const tracker = initActivityTracker(TEST_BASE_DIR);
